...
Example:
	parallel testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "parallel", "Home directory of the node's daemon configuration")
